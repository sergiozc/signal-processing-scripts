...
index_freq = [3, 7, 12, 17, 33, 49, 69, 81, 97, 129];
...
hold on
polarplot(theta_polar, D_matrix(8,:),'Color',[color_map(8,:)]);
hold on
polarplot(theta_polar, D_matrix(9,:),'Color',[color_map(9,:)]);
hold on
polarplot(theta_polar, D_matrix(10,:),'Color',[color_map(10,:)]);
